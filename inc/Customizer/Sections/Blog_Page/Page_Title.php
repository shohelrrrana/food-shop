...
class Page_Title extends Blog_Page {
    protected $section     = 'blog_page_page_title_section';
    protected $option_name = 'blog_page_page_title_section';
        ...
        \Kirki::add_field( $this->config, [
            ...
            'partial_refresh' => [
                $this->section . 'section_title' => [
                    'selector'        => '#page_title .section_title',
        ...
        \Kirki::add_field( $this->config, [
            ...
            'partial_refresh' => [
                $this->section . 'section_description' => [
                    'selector'        => '#page_title .section_description',
                    'render_callback' => function () {
